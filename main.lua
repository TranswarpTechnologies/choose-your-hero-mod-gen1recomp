...
------------------------------------------------------------
-- Global Dialogue Overrides
------------------------------------------------------------
-- TEMPORARY:
-- These are intentionally applied to every save regardless of whether the player selected RED or GREEN.
-- Conditional text overrides do not appear to be possible, nor present in the current game engine.
------------------------------------------------------------

local textChanges = {
    _RedsHouse1FMomWakeUpText =
    "MOM: Right.\nAll kids leave\vhome some day.\vIt said so on TV.\fPROF.OAK, next\ndoor, is looking\vfor you.",
                                        ...
                                        sprites.SPRITE_RED_BIKE.image = asset(BIKE)
                                            ...
                                            if sprites.SPRITE_BLUE then
                                                ...
                                                if not vanilla.rivalWalk then
                                                    ...
                                                    if isYellow() then
                                                        sprites.SPRITE_BLUE.image =
                                                        asset("assets/sprites/yellow.png")
                                                        else
